        ...
        <div class="container">
          <nav id="menuzord" class="menuzord default" style="background-color: #fca311 ;">        
            <ul class="menuzord-menu">
              <li style="font-size: 20px; color: black; margin-left: -150px;"> <button style="background-color: #fca311 ;border: #fca311; cursor: default;"><img src="https://i.postimg.cc/brBTc1N2/logodesa.png" style="width: 40%;"></button></li>
              <li class="active"><a href="/dashdesa" style="margin-left: 70px;">Beranda</a>
                <ul class="">
                    <ul class="">
                    </ul>
                  </li>
            ...
            <div class="pull-right flip hidden-sm hidden-xs mt-20 pt-5" style="margin-right: 70px;">
             <a class="btn" href="find_do/dash-web" style="background-color:#F26522; color:#fff; border-radius: 10px;"><b>Kembali</b></a>
            </div>
            <div class="pull-right flip hidden-sm hidden-xs" style="margin-top: -37px; margin-right: -80px;">
            <a class="btn btn-colored btn-flat" href="admin-desa/dashboard.html" style="background-color:#F26522; color:#fff; border-radius: 10px;"><b>Kelola Desa</b></a>
          </div>
          </nav>
        </div>
      </div>
      ...
      <div class="container pb-40">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase line-bottom-center mt-0">Update <span class="" style="color: #F26522">Terkini</span></h2>
            </div> 
          </div>
        </div>
        <div class="row multi-row-clearfix">
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/K83Vydtb/berita.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                ...
                <a href="lihatberita.html" class="btn btn-default btn-xs font-16 mt-10" style="color: #F26522">Baca </a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/hP4F2Y70/berita2.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                <h4 class="text-uppercase"><a href="lihatberita.html">Judul Berita</a></h4>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/NMvSmCcm/berita3.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                <h4 class="text-uppercase"><a href="lihatberita.html">Judul Berita</a></h4>
      ...
      <div class="container pb-40">
        ...
        <div class="row multi-row-clearfix">
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/J7drRHsW/penghargaan.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                <h4 class="text-uppercase"><a href="lihatpenghargaan.html">Penghargaan Adiwiyata</a></h4>
                
                <p class="mt-20" style="text-align: justify;">Penghargaan adiwiyata di dapatkan Oleh desa ngijo</p>
                <a href="lihatpenghargaan.html" class="btn btn-default btn-xs font-16 mt-10" style="color: #F26522">Baca </a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/L5kGY7m7/penghargaan2.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                <h4 class="text-uppercase"><a href="lihatpenghargaan.html">Adi Budiman Menangkan Lomba Badminton</a></h4>
                
                <p class="mt-20" style="text-align: justify;">Adi menjadi contoh telah menang lomba badminton antar kecamatan selain mengharumkan nama kecamatan ia juga megharumkan Desa nya</p>
                <a href="lihatpenghargaan.html" class="btn btn-default btn-xs font-16 mt-10" style="color: #F26522">Baca </a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="causes bg-silver-light maxwidth500 mb-30">
              <div class="thumb" style="height: 200px;">
                <img src="https://i.postimg.cc/d3LnrdWc/penghargaan3.jpg" alt="" class="img-fullwidth">
              </div>
              <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                <h4 class="text-uppercase"><a href="lihatpenghargaan.html">Menangkan Lebih dari 10 Lomba Ping pong</a></h4>
     
                <p class="mt-20" style="text-align: justify;">Pak Henry telah menangkan lebih dari 10 pertandingan 17 Agustus an bersama rival nya yang selalu runner up namun pak Henry selalu sukses membawa medali emas lihat</p>
                <a href="lihatpenghargaan.html" class="btn btn-default btn-xs font-16 mt-10" style="color: #F26522">Baca </a>
              </div>
            </div>
          </div>
