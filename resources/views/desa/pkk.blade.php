...
<div id="wrapper" class="clearfix">
  ...
  <!-- image header -->
  <section class="inner-header divider layer-overlay overlay-dark-8" data-bg-img="https://i.postimg.cc/XqJTjH9W/sedang-1614760636-Screenshot-14.jpg">
        ...
        <div class="container">
            <center>
                ...
                <table class=" table-hover mt-3 content-table">
                  ...
                  <tr>
                      <th scope="row">1</th>
                      <td><center><img  style="width: 200px;height: 120px;" src="images/gallery/monyet.webp" alt=""></center></td>
                      <td><center>Sumarno</center></td>
                      <td><center>Ketua Karang Tarnuna</center></td>
                  </tr>
                  <tr>
                      <th scope="row">2</th>
                      <td><center><img  style="width: 200px;height: 120px;" src="images/gallery/monyet.webp" alt=""></center></td>
                      <td><center> Thornton</center></td>
                      <td><center> Wakil Karang Tarnuna</center></td>
                  </tr>
                  <tr>
                      <th scope="row">3</th>
                      <td><center><img  style="width: 200px;height: 120px;" src="images/gallery/monyet.webp" alt=""></center></td>
                      <td><center> Farida </center></td>
                      <td><center> Sekretaris Karang Tarnuna </center></td>
                  </tr>
                  <tr>
                    <th scope="row">4</th>
                    <td><center><img  style="width: 200px;height: 120px;" src="images/gallery/monyet.webp" alt=""></center></td>
                    <td><center> Raisa </center></td>
                    <td><center> Bendahara Karang Tarnuna </center></td>
                </tr>
                <tr style="justify-content: center;">
                  <th scope="row">5</th>
                  <td><center><img  style="width: 200px;height: 120px;" src="images/gallery/monyet.webp" alt=""></center></td>
                  <td><center> Putri </center></td>
