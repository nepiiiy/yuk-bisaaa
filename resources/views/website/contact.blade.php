...
.botao-wpp1:hover {
  background-color: darken(#e24d4d, 5%);
}

.botao-wpp1:focus {
  background-color: darken(#e24d4d, 15%);
}
...
.botao-wpp2:hover {
  background-color: darken(#ff7b00, 5%);
}

.botao-wpp2:focus {
  background-color: darken(#ff7b00, 15%);
}
</style>
</head>
<body class="">
            ...
            <ul class="menuzord-menu">
              <li ><a href="/dashweb">Beranda</a>
                <li ><a href="/about">Tentang</a>
                    <li class="active"><a href="/contact">Kontak</a>
...
<section style="width:700px; height: 500px; margin-left: 30px;">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31668.030672749563!2d109.35274032835964!3d-7.183203589042299!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6feffdb0412969%3A0x5027a76e3564d90!2sKuta%2C%20Kec.%20Belik%2C%20Kabupaten%20Pemalang%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1676210361241!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
               
</section>
    <!-- Section: About  -->
    <section class="clearfix" style="margin-left: 800px; margin-top: -500px;">
        <div class="contact-left" >
    <div class="cp-lat" data-lat="40.7531082"></div>
    <div class="cp-lan" data-lan="-73.9314083"></div>
    <div id="cpmap" class="contactmap" data-pinicon = "https://classic.listingprowp.com/wp-content/uploads/2017/01/pin.png">
    </div>
</div>
            <div  class="">
    <div  class=" padding-top-60 padding-bottom-50 contact-right ">
            ...
            <div class="address-box mr-bottom-30">
                    ...
                    <span style="font-size: 18px;">Malang</span>
                </p>
                                    <p>
                    <i class="fa fa-phone" style="font-size: 18px;"></i>
                    <a href="tel:+008 1234 6789" style="font-size: 18px;"> <span>+008 1234 6789</span></a>
                </p>
                                    <p>
                    ...
                    <a href="mailto:xyz@example.com" style="font-size: 18px;"> <span>xyz@example.com</span></a>
                        ...
                        <div style="margin-top: -48px; margin-left:180px;">
                        <a href="whatsapp://send?text=Link pra um artigo ó https://google.com" class="botao-wpp1" style="font-size: 15px; margin-top: -10px;">
                            <!-- ícone -->
                            <i class="fa fa-instagram" style="font-size: 15px;"></i>
                            Instagram
                          </a>
                        </div>
                        <div style="margin-top: -57px; margin-left:360px;">
                        <a href="whatsapp://send?text=Link pra um artigo ó https://google.com" class="botao-wpp2" style="font-size: 15px;">
                            <!-- ícone -->
